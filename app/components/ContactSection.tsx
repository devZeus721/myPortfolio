			...
			<div className="max-w-2xl mx-auto">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-6">
					...
					<div className="flex items-center justify-center gap-2 text-gray-300">
						...
						<span><b>Bangalore KA & Alappuzha KERALA</b></span>
						{/*<span><b><br>India</br></b></span>*/}
					</div>
...
>
  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    <path d="M13.753 2.47a1.6 1.6 0 00-3.15 0c-2.972 1.008-5.1 3.306-5.1 6.177 0 1.385.545 2.543 1.257 3.43l-.81.81c-.263.263-.263.689 0 .953l.73.73v5.423c0 .487.396.883.883.883h1.012a.883.883 0 00.883-.883V18.7h5.116v1.073c0 .487.396.883.883.883h1.013a.883.883 0 00.883-.883V14.57l.73-.73a.672.672 0 000-.953l-.811-.81c.713-.887 1.257-2.045 1.257-3.43 0-2.871-2.128-5.169-5.1-6.177zM12 3.152a.373.373 0 01.363.289 8.303 8.303 0 011.418.384 7.04 7.04 0 012.465 1.625c1.518 1.409 2.316 3.164 2.316 5.197 0 1.053-.37 2.01-.978 2.736l-.05.06c-.045.05-.123.05-.168 0a.118.118 0 01-.025-.12c.597-1.443.368-2.932-1.058-4.35-.921-.916-2.105-1.39-3.287-1.378a.126.126 0 01-.125-.125V3.44A.375.375 0 0112 3.152zm0 2.048l.001 2.476c1.188.004 2.287.41 3.115 1.236 1.197 1.192 1.232 2.579.704 3.654a.124.124 0 01-.125.06c-1.079-.16-2.124-.526-3.684-1.167a46.486 46.486 0 00-3.684 1.167.123.123 0 01-.125-.06c-.528-1.075-.493-2.462.704-3.654.83-.827 1.927-1.232 3.114-1.236zm-2.368 8.74c.022.02.053.02.075 0 .968-.877 2.278-.877 3.246 0a.053.053 0 00.075 0 .053.053 0 000-.075c-.946-.854-2.45-.854-3.397 0a.052.052 0 000 .075zm1.184 1.128c.432.049.953.493.953 1.091v1.204h-1.906v-1.204c0-.598.52-1.042.953-1.091zm-3.116 2.37v-2.67l.796-.796c.069-.07.164-.07.232 0a.677.677 0 00.953 0l.796-.796v2.67H7.7zm8.3 0h-1.254v-2.67l.796.796a.677.677 0 00.953 0c.069-.07.164-.07.232 0l.796.796v2.67z" />
  </svg>
</a>
